...
class TopicReportAdmin(django.contrib.admin.ModelAdmin):
    list_display = ('reporter', 'reason', 'topic')
    readonly_fields = ('reporter', 'reason', 'topic')
    list_display_links = ('reporter', 'topic')


@django.contrib.admin.register(forum.models.AnswerReport)
class AnswerReportAdmin(django.contrib.admin.ModelAdmin):
    list_display = ('reporter', 'reason', 'answer')
    readonly_fields = ('reporter', 'reason', 'answer')
    list_display_links = ('reporter', 'answer')
